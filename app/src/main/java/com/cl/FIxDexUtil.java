...
public class FIxDexUtil {
     ...
     */
    public static void loadFixDex(Context context, File patchFileDir) {
    ...
    private static void doDexInject(Context appContext, HashSet<File> loadedDex) {
        ...
        // data/data/packageName/files/optimize_dex
        ...
        try {
            ...
            for (File dex : loadedDex) {
                ...
                Toast.makeText(appContext, "热修复完成", Toast.LENGTH_SHORT).show();
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
